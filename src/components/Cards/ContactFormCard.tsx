...
export const ContactFormCard = () => {
  ...
  const sendEmail = async (e: React.FormEvent) => {
    ...
    const sendEmailPromise = new Promise(async (resolve, reject) => {
      try {
        const response = await emailjs.send(
          "service_6vdpgyl", // Service ID
          "template_ea18mng", // Template ID
          {
        ...
        reject(new Error(emailError?.text || "Failed to send message via EmailJS."));
      } finally {
        setIsSending(false);
      }
    });
    ...
    toast.promise(sendEmailPromise, {
      ...
      success: "Message securely delivered! I'll get back to you soon.",

...
export const Footer = () => {
  ...
  const socialLinks = [
    {
      icon: LuLinkedin,
      href: `https://www.linkedin.com/in/${selfData.socials_username.linkedin}`,
      label: "LinkedIn",
    },
    {
      icon: LuTwitter,
    ...
    {
      icon: FaYoutube,
      href: `https://www.youtube.com/${selfData.socials_username.youtube}`,
      label: "YouTube",
    },
    {
      icon: FaFacebook,
      href: `https://www.facebook.com/${selfData.socials_username.facebook}`,
      label: "Facebook",
    },

...
export function EmailTemplate({
  ...
  const socials = [
    ...
    {
      name: "YouTube",
      url: `https://www.youtube.com/${selfData.socials_username.youtube}`,
      icon: "https://cdn-icons-png.flaticon.com/512/1384/1384060.png",
    },
    {
      name: "Facebook",
      url: `https://www.facebook.com/${selfData.socials_username.facebook}`,
          ...
          <Section style={header}>
            <Row>
              <Column style={{ width: "40px" }}>
                <Img
                  src="https://waleed-hussain-dev.vercel.app/images/logo.png"
                  alt="AN"
                  width="40"
                  height="40"
                />
              ...
              <Column>
                <Text style={brandText}>Waleed Hussain</Text>
              </Column>
            </Row>
          </Section>
